...
# 0_1_2
python unified_babel_convertor.py --task totto tabfact hybridqa sqa feverous --objective oneshot --split validation --linear_func html --unified --unified_file_output ./exps/downstream_tasks_20230119_manual_log/0_1_2 --use_partition_mark --add_table_size --use_role_prompting


# generate table-based downstream tasks (zero-shot)
python unified_babel_convertor.py --task totto tabfact hybridqa sqa feverous --objective zeroshot --split validation --linear_func html --unified --unified_file_output ./exps/downstream_tasks_20230120_manual_zeroshot_log/0_1_2_3 --use_role_prompting --add_table_size --use_format_explanation --use_partition_mark
# 0_2_3
python unified_babel_convertor.py --task totto tabfact hybridqa sqa feverous --objective zeroshot --split validation --linear_func html --unified --unified_file_output ./exps/downstream_tasks_20230120_manual_zeroshot_log/0_2_3 --use_role_prompting --use_format_explanation --use_partition_mark
# 0_1_3
python unified_babel_convertor.py --task totto tabfact hybridqa sqa feverous --objective zeroshot --split validation --linear_func html --unified --unified_file_output ./exps/downstream_tasks_20230120_manual_zeroshot_log/0_1_3 --add_table_size --use_role_prompting --use_format_explanation
# 1_2_3
python unified_babel_convertor.py --task totto tabfact hybridqa sqa feverous --objective zeroshot --split validation --linear_func html --unified --unified_file_output ./exps/downstream_tasks_20230120_manual_zeroshot_log/1_2_3 --use_format_explanation --add_table_size --use_partition_mark
# 0_1_2
python unified_babel_convertor.py --task totto tabfact hybridqa sqa feverous --objective zeroshot --split validation --linear_func html --unified --unified_file_output ./exps/downstream_tasks_20230120_manual_zeroshot_log/0_1_2 --use_partition_mark --add_table_size --use_role_prompting
