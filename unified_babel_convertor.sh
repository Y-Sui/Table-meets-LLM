...
# 0_1_3
python unified_babel_convertor.py --task totto tabfact hybridqa sqa feverous --objective oneshot --split validation --linear_func html --unified --unified_file_output ./exps/downstream_tasks_20230119_manual_log/ --add_table_size --use_role_prompting --use_format_explanation
# 1_2_3
python unified_babel_convertor.py --task totto tabfact hybridqa sqa feverous --objective oneshot --split validation --linear_func html --unified --unified_file_output ./exps/downstream_tasks_20230119_manual_log/ --use_format_explanation --add_table_size --use_partition_mark

## generate self-augmented information
#python unified_babel_convertor.py --task totto tabfact hybridqa sqa feverous --objective heur_0 heur_1 --split validation --linear_func html